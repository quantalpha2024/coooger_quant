...
def calc_profit_loss_ratio(df):
    '''
     平仓盈亏比 = 总盈利金额 / 总亏损金额   （注意：总亏损金额取绝对值）
     其中，总盈利金额 = 所有盈利交易的平仓盈亏之和（正值），
     总亏损金额 = 所有亏损交易的平仓盈亏之和（负值）的绝对值。
    '''
    close_trades = df.loc[
        (df['CloseProfit'] != 0)]
    # 总盈利金额
...
'0899b613-fbe6-47d0-8b66-57218ccb939a',
'1586107a-b674-4a4c-a225-a7b6f06b33ea',
'df9281b6-d44d-4f2a-85bc-83c5db58f7f1',
'c32cfd3f-5010-4603-99d3-34d7cea57d04',
'78ec396e-07a0-4e97-8d99-6b6fdadb6671',
'00d87dc8-fa6c-409b-918d-6fde3a423eaa',
'c9c03175-99ec-4b0a-9c49-a4c4ae82185a',
'3c349ca0-cfda-47ed-887f-8efd62621e3d',
'38275638-1f74-46f5-9d90-7cce3d7b1acd',
'2535a0c9-983b-4e95-8697-4fa2f8235122',
...
'51c85974-553c-4a65-b504-a91b7f504b77',
'27f2b154-18aa-405d-a14f-73521d9908d9',
'6ada1706-64a4-4067-ad0c-918d578f8782',
'c9c03175-99ec-4b0a-9c49-a4c4ae82185a',
'c7bd2eec-fd67-4634-bed9-daf9ded5d510',
'1369a0fa-d985-462b-9d67-d7bf4859f55e',
'56dec90c-c708-4f98-8534-5bac8fb219f4',
'a97d764e-09c4-4247-be76-68fd2dd2adf6',
'5fd7a139-dbe7-4295-a695-85054371b410',
'109b56ab-eb81-4eb8-88d3-a3409ce56e05',
'd3b79a40-49ca-424c-a1e0-9bb84c6d6513',
'c7d61ee8-eb4f-4869-a41b-56611eb85e12',
'd1654c50-f5a9-4aa3-a261-44c02a17ff12',
'061677c3-8196-4202-86da-c61c75bc4f36',
'c32cfd3f-5010-4603-99d3-34d7cea57d04',
'03f8a190-423d-4fbd-863b-27859cd5fc29',
'845d7164-1b4a-44a9-87dd-067bc3f9047b',
'627f6adb-7ad8-42fb-b021-fda0f538e5b5',
'38275638-1f74-46f5-9d90-7cce3d7b1acd',
'0861e1c6-f9e5-48dc-b34a-88bff5271467']:
            # MemberID['MemberID']:
        N = N + 1
        ...
        df = pd.DataFrame(result_data,
                          columns=['CreateTime', 'AccountDetailID', 'MemberID', 'Balance', 'Source', 'Amount'])
        ...
        result.loc[memberid, 'Number of Liquidations'] = df.loc[df['Balance']<0].shape[0]

        data_query = f"""
                        SELECT TradeTimeMs,CloseProfit
FROM t_d_trade 
